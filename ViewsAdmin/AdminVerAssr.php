...
<div class="contenedor-update">
    <h1 class="B-Texto-Mostrar"> Informacion del Asesor</h1>
    <br>
    <form action="../Login/MostrarAssrAdmin.php" method="POST">
        ...
        if (isset($_GET['id'])) {
            ...
            if ($resultado) {
                ...
                echo '<label class="B-Texto-Mostrar">Telefono:</label> <input type="tel" name="telefono" value="' . $telefono . '"><br>';
